								...
								<div class="row">
									...
									<div class="col-12">
										<div class="form-group mb-3">
											...
											<input type="text" name="exam_name" class="form-control @error('exam_name') is-invalid @enderror" id="exam_name" placeholder="Enter exam name" value="{{ $exam->exam_name }}">
											@error('exam_name')
												<div class="text-danger">{{ $message }}</div>
											@enderror
										</div>
									...
									<div class="col-md-6">
										<div class="form-group mb-3">
											...
											<select name="question_type" id="question_type" class="form-control form-select question_type @error('question_type') is-invalid @enderror">
												...
												<option value="1" {{ $exam->question_type == '1' ? 'selected' : '' }}>Random</option>
												<option value="0" {{ $exam->question_type == '0' ? 'selected' : '' }}>Selected</option>
											</select>
											@error('question_type')
												<div class="text-danger">{{ $message }}</div>
											@enderror
