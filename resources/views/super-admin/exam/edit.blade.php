		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title m-0">Edit Subject </h4>
				</div>
				<div class="card-body">
					<form action="{{ route('super-admin.subjects.update', $subject->id) }}" method="POST" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						...
						<div class="row justify-content-center">
							...
							<div class="col-md-4">
								<div class="form-group mb-3">
									...
									<input type="text" name="subject_name" class="form-control @error('subject_name') is-invalid @enderror" id="subject_name" placeholder="Enter subject name" value="{{ old('subject_name') ?? $subject->subject_name }}">
									@error('subject_name')
										<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
