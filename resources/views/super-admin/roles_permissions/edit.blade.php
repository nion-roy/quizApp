		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<form action="{{ route('super-admin.roles-permissions.update', $role->id) }}" method="POST">
						@csrf
						@method('PUT')
						...
						<div class="form-group">
							<a class="btn btn-danger waves-effect" href="{{ route('super-admin.roles-permissions.index') }}"><i class="fas fa-arrow-left me-2"></i>Back Now</a>
