						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group mb-3">
									...
									<input type="date" name="exam_date" class="form-control @error('exam_date') is-invalid @enderror" id="exam_date" placeholder="Enter exam name" value="{{ old('exam_date') }}">
									@error('exam_date')
										<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="col-md-6">
								<div class="form-group mb-3">
									...
									<input type="time" name="exam_duration" class="form-control @error('exam_duration') is-invalid @enderror" id="exam_duration" placeholder="Enter exam name" value="{{ old('exam_duration') }}">
									@error('exam_duration')
										<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
