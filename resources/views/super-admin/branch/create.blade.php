		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title m-0">New Branch Create </h4>
				</div>
				<div class="card-body">
						...
						<div class="row justify-content-center">
							<div class="col-md-3">
								<div class="form-group mb-3">
									...
									<input type="text" name="branch" class="form-control @error('branch') is-invalid @enderror" id="branch" placeholder="Enter branch name" value="{{ old('branch') }}">
									@error('branch')
