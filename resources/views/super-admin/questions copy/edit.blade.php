						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group mb-3">
									...
									<input type="text" name="exam_name" class="form-control @error('exam_name') is-invalid @enderror" id="exam_name" placeholder="Enter exam name" value="{{ old('exam_name') ?? $question->exam_name }}">
									@error('exam_name')
										<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="col-md-6">
								<div class="form-group mb-3">
									...
									<input type="text" name="exam_date" class="form-control @error('exam_date') is-invalid @enderror" id="exam_date" placeholder="Enter start exam date" value="{{ old('exam_date') ?? $question->exam_date }}">
									@error('exam_date')
										<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="col-md-6">
								<div class="form-group mb-3">
									...
									<input type="number" min="0" name="exam_duration" class="form-control @error('exam_duration') is-invalid @enderror" id="exam_duration" placeholder="Enter exam duration" value="{{ old('exam_duration') ?? $question->exam_duration }}">
									@error('exam_duration')
										<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
										...
										<div class="question-row">
											<div class="form-group mb-3">
												<div class="d-flex align-items-center justify-content-between mb-2">
													<label class="form-label question-label" for="question_name">Question Name {{ $key + 1 }} <span class="text-danger">*</span></label>
													<button type="button" class="btn btn-success btn-sm font-size-14 add-row-question">Add Row</button>
												</div>
												<input type="text" name="question_name[]" class="form-control" id="question_name" placeholder="Enter question name {{ $key + 1 }}" value="{{ $questionOption->question_name }}" required>
											</div>
											...
											<div class="row">
												<div class="col-md-3">
													<div class="form-group mb-3">
														...
														<input type="text" name="option_1[]" class="form-control" id="option_1" placeholder="Enter option 01" value="{{ $questionOption->option_1 }}" required>
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group mb-3">
														...
														<input type="text" name="option_2[]" class="form-control" id="option_2" placeholder="Enter option 02" value="{{ $questionOption->option_2 }}" required>
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group mb-3">
														...
														<input type="text" name="option_3[]" class="form-control" id="option_3" placeholder="Enter option 03" value="{{ $questionOption->option_3 }}" required>
													</div>
												</div>
												...
												<div class="col-md-3">
													<div class="form-group mb-3">
														...
														<input type="text" name="option_4[]" class="form-control" id="option_4" placeholder="Enter option 04" value="{{ $questionOption->option_4 }}" required>
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group mb-3">
														...
														<select name="correct_answer[]" class="form-control form-select @error('correct_answer') is-invalid @enderror">
															...
															<option value="1" {{ $question->correct_answer == 1 ? 'selected' : '' }}>Option 01</option>
															<option value="2" {{ $question->correct_answer == 2 ? 'selected' : '' }}>Option 02</option>
															<option value="3" {{ $question->correct_answer == 3 ? 'selected' : '' }}>Option 03</option>
															<option value="4" {{ $question->correct_answer == 4 ? 'selected' : '' }}>Option 04</option>
														</select>
